...
export const en: Locale = {
  ...
  pixal3d: {
    generator: {
      ...
      promptPlaceholder: "Describe the image you want to generate with Nano Banana 2...",
      referenceImagesLabel: "Reference Images",
      referenceImagesHint: "Optional visual references",
      imageHint: "Optional reference images for Nano Banana image generation.",
      imagePreviewAlt: "Uploaded reference image",
      uploadButton: "Add references",
      dragDropPaste: "Drag & drop",
      orLabel: "OR",
      selectFileButton: "Select images",
      ...
      errors: {
        ...
        imageRequired: "Enter a prompt or upload a reference image first.",
        ...
        generateDisabledImageRequired: "Enter a prompt first",
