...
// 2. env.example contains placeholder values which are sufficient for build-time setup.
// 3. Build-time setup should not require an actual database connection.
